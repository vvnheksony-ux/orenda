...
export default async function VisionMission() {
  ...
  return (
    <div className="flex flex-col gap-[40px] w-full">
      ...
      <div className="flex flex-col gap-6 w-full lg:relative lg:block lg:min-h-[500px]">
      ...
      <div className="flex flex-col gap-6 w-full lg:relative lg:block lg:min-h-[472px]">
