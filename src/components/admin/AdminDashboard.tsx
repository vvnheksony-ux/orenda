...
function ControlButton({ icon: Icon, label }: { icon: React.ComponentType<{ className?: string }>; label: string }) {
  return (
    <button className="inline-flex h-11 items-center gap-3 rounded-xl border border-[#eee8dd] bg-white px-5 text-sm font-semibold text-[#6d675f] shadow-sm transition hover:border-[#d7c7a9] hover:text-[#8a672c]">
