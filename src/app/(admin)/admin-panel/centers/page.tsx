...
export default function CentersPage() {
  return (
    <AdminPageFrame title="Center of Excellence" breadcrumb="Hospital > Center of Excellence" searchPlaceholder="Search Center of Excellence..." primaryActionLabel="Add Center of Excellence">
