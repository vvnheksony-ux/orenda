    ...
    <SiteLayout>
      <div className="bg-[#fbf7ee] w-full">
        <div className="flex flex-col items-center pb-[120px] pt-[100px] lg:pt-[212px] w-full">
          ...
          <div className="max-w-[1512px] mx-auto w-full flex flex-col gap-[80px] items-center px-4 sm:px-8 lg:px-[80px]">
            {/* Hero */}
            <div className="flex gap-[16px] h-[472px] items-center justify-center w-full">
              ...
              <div className="bg-white flex h-[472px] items-center justify-between overflow-hidden relative rounded-[16px] flex-1 p-[12px] pl-[58px]">
                <div className="flex flex-col gap-[40px] items-start flex-1 pr-[32px] min-w-[300px]">
                  ...
                  <Link href="/about" className="flex items-center h-[48px] px-[20px] py-[14px] border-[1.5px] border-[#b89148] rounded-[12px] gap-[4px] hover:bg-[#b89148]/10 transition-colors">
                    <span className="font-dm-sans text-[18px] text-[#5c4924] px-[8px]">Learn More</span>
                    <ArrowRight size={20} className="text-[#5c4924]" />
                  </Link>
                </div>
                <div className="relative h-full rounded-[16px] shrink w-[50%] max-w-[650px] overflow-hidden">
