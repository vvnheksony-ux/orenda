    ...
    <SiteLayout>
      <div className="bg-[#fbf7ee] w-full">
        <div className="page-shell flex flex-col gap-[80px] items-center pb-[120px] pt-[100px] lg:pt-[212px]">
          ...
          {/* Hero */}
          <PromotionStyleHero
            imageSrc={clinic.icon || '/images/about/about-hero-3.jpg'}
            imageAlt={clinic.name}
            title={clinic.name}
            lines={[
              `World-class ${clinic.name} services at Orienda International Hospital.`,
          ...
          <div className="flex flex-col sm:flex-row gap-[24px] lg:gap-[40px] items-center sm:items-start w-full max-w-[1352px] text-center sm:text-left">
            {clinic.icon && (
              <div className="shrink-0 size-[176px] relative">
                <Image src={clinic.icon} alt={clinic.name} fill className="object-contain" sizes="176px" unoptimized />
              </div>
            )}
            <div className="flex flex-col gap-[16px]">
              <h2 className="font-cormorant font-bold text-[36px] sm:text-[42px] lg:text-[48px] text-[#3b2d17] leading-none">{clinic.name}</h2>
